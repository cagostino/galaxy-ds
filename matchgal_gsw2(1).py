...
groups1_3xmmm_bptplus, nonagn_3xmmm_bptplus, agn_3xmmm_bptplus  = EL_3xmm.get_bptplus_groups()
groups1_3xmmm_bptplusnii, nonagn_3xmmm_bptplusnii, agn_3xmmm_bptplusnii  = EL_3xmm.get_bptplus_niigroups()

groups1_3xmmm_all,nonagn_3xmmm_all, agn_3xmmm_all = EL_3xmm_all.get_bpt1_groups()
groups1_3xmmm_all_bptplus,nonagn_3xmmm_all_bptplus, agn_3xmmm_all_bptplus = EL_3xmm_all.get_bptplus_groups()
...
sfrm_gsw2.get_highsn_match_only(agn_gsw_bptplus, nonagn_gsw_bptplus, 
                                nonagn_gsw_bptplusnii, agn_gsw_bptplusnii, 
                                load=True, sncut=2, with_av=True)
sfrm_gsw2.subtract_elflux(sncut=2,  halphbeta_sncut=10)
sfrm_gsw2.bin_by_bpt(binsize=0.1)

'''
d4000m_gsw2 = SFRMatch(EL_m2)

d4000m_gsw2.get_highsn_match_only_d4000(agn_gsw_bptplus, nonagn_gsw_bptplus, 
                                nonagn_gsw_bptplusnii, agn_gsw_bptplusnii, 
                                load=False, sncut=2, with_av=True, fname='')
...
def match_xrgal_to_sfrm_obj(xrids, sfrmids):
    ...
    for i, xrid in enumerate(xrids):
        ...
        if match <26080:
            ...
            matching_ind_plus.append(match-26080)
            xrind_plus.append(i)
        else:
            matching_ind_neither.append(match-47404)
