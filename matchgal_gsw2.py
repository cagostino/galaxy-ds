...
#actmatch_3xmm_gsw = catmatch_act(x3.ra,x3.dec,m2Cat_GSW.allra,m2Cat_GSW.alldec, m2_photrfluxmatched, x3.fullflux)
...
m2Cat_GSW_qsos = GSWCatmatch3xmm( np.arange(len(m2[0])), m2, redshift_m2, allm2, sedflag=1)

m2Cat_GSW_3xmm = GSWCatmatch3xmm(x3.idm2[x3.medtimefilt], m2, redshift_m2, allm2, x3.fullflux_filt, x3.hardflux_filt, x3.hardflux2_filt, x3.softflux_filt)
m2Cat_GSW_3xmm_all = GSWCatmatch3xmm( x3.idm2[x3.medtimefilt_all], m2, redshift_m2, allm2, x3.fullflux_all, x3.hardflux_all, x3.hardflux2_all, x3.softflux_all)
m2Cat_GSW_3xmm.exptimes = x3.logmedtimes[x3.medtimefilt]
...
mpa_spec_allm2 = MPAJHU_Spec(m2Cat_GSW_3xmm, sdssobj, find=False, gsw=True)
...
EL_m2 = ELObj(mpa_spec_allm2.spec_inds_prac , sdssobj, mpa_spec_allm2.make_prac,m2Cat_GSW_3xmm,gsw=True)
...
groups1_gsw, nonagn_gsw, agn_gsw = EL_m2.get_bpt1_groups()

groups1_gsw_bptplus, nonagn_gsw_bptplus, agn_gsw_bptplus = EL_m2.get_bptplus_groups()

groups1_gsw_bptplusnii, nonagn_gsw_bptplusnii, agn_gsw_bptplusnii = EL_m2.get_bptplus_niigroups()

groups1_gswtbt, nonagn_gswtbt, agn_gswtbt = EL_m2.get_bpt1_groups(filt=EL_m2.bpt_sn_filt[EL_m2.tbt_filt])
groups1_gswvo87_1, nonagn_gswvo87_1, agn_gswvo87_1 = EL_m2.get_bpt1_groups(filt=EL_m2.bpt_sn_filt[EL_m2.vo87_1_filt])
groups1_gswvo87_2, nonagn_gswvo87_2, agn_gswvo87_2 = EL_m2.get_bpt1_groups(filt=EL_m2.bpt_sn_filt[EL_m2.vo87_2_filt])

#first one should be the same as groups1_gsw
groups1_gsw_sn2, nonagn_gsw_sn2, agn_gsw_sn2 = EL_m2.get_bpt1_groups(filt=EL_m2.bpt_sn_filt)
groups1_gsw_sn2_minus_lr2, nonagn_gsw_sn2_minus_lr2, agn_gsw_sn2_minus_lr2 = EL_m2.get_bpt1_groups(filt=EL_m2.bpt_sn_minus_bpt_sn_lr2_filt)

groups1_gsw_sn3, nonagn_gsw_sn3, agn_gsw_sn3 = EL_m2.get_bpt1_groups(filt=EL_m2.bpt_sn3_filt)
groups1_gsw_snlr3, nonagn_gsw_snlr3, agn_gsw_snlr3 = EL_m2.get_bpt1_groups(filt=EL_m2.bpt_sn_lr3_filt)
groups1_gsw_snlr2, nonagn_gsw_snlr2, agn_gsw_snlr2 = EL_m2.get_bpt1_groups(filt=EL_m2.bpt_sn_lr2_filt)
groups1_gsw_snlr1, nonagn_gsw_snlr1, agn_gsw_snlr1 = EL_m2.get_bpt1_groups(filt=EL_m2.bpt_sn_lr1_filt)

groups1_qsos, nonagn_qsos, agn_qsos = EL_qsos.get_bpt1_groups()

groups1_gsw_no, nonagn_gsw_no, agn_gsw_no = EL_m2.get_bpt1_groups()
groups1_gsw_oiii, nonagn_gsw_oiii, agn_gsw_oiii = EL_m2.get_bpt1_groups()
...
softxray_xmm = Xraysfr(m2Cat_GSW_3xmm.softlumsrf, m2Cat_GSW_3xmm, mpa_spec_m2_3xmm.make_prac[EL_3xmm.bpt_sn_filt], agn_3xmmm,nonagn_3xmmm, 'soft')
hardxray_xmm = Xraysfr(m2Cat_GSW_3xmm.hardlumsrf, m2Cat_GSW_3xmm, mpa_spec_m2_3xmm.make_prac[EL_3xmm.bpt_sn_filt], agn_3xmmm,nonagn_3xmmm,'hard')
fullxray_xmm = Xraysfr(m2Cat_GSW_3xmm.fulllumsrf, m2Cat_GSW_3xmm, mpa_spec_m2_3xmm.make_prac[EL_3xmm.bpt_sn_filt], agn_3xmmm, nonagn_3xmmm, 'full')

fullxray_xmm_dr7 = Xraysfr(m2Cat_GSW_3xmm.fulllumsrf, m2Cat_GSW_3xmm, mpa_spec_m2_3xmm.make_prac, agn_3xmmm, nonagn_3xmmm, 'full')

softxray_xmm_all = Xraysfr(m2Cat_GSW_3xmm_all.softlumsrf, m2Cat_GSW_3xmm_all, mpa_spec_m2_3xmm_all.make_prac[EL_3xmm_all.bpt_sn_filt], agn_3xmmm_all,nonagn_3xmmm_all, 'soft')
hardxray_xmm_all = Xraysfr(m2Cat_GSW_3xmm_all.hardlumsrf, m2Cat_GSW_3xmm_all, mpa_spec_m2_3xmm_all.make_prac[EL_3xmm_all.bpt_sn_filt], agn_3xmmm_all,nonagn_3xmmm_all, 'hard')
fullxray_xmm_all = Xraysfr(m2Cat_GSW_3xmm_all.fulllumsrf, m2Cat_GSW_3xmm_all, mpa_spec_m2_3xmm_all.make_prac[EL_3xmm_all.bpt_sn_filt], agn_3xmmm_all, nonagn_3xmmm_all, 'full')
...
xmm3eldiagmed_xrfilt = ELObj(mpa_spec_m2_3xmm.spec_inds_prac[EL_3xmm.bpt_sn_filt][fullxray_xmm.valid][fullxray_xmm.likelyagn_xr], sdssobj,
                             mpa_spec_m2_3xmm.make_prac[EL_3xmm.bpt_sn_filt][fullxray_xmm.valid][fullxray_xmm.likelyagn_xr], m2Cat_GSW_3xmm,xr=True)
...
'''
Distance analysis begins here, unnecessary for gsw2 stuff so far...

#GDIFFS
xmm3inds = m2Cat_GSW_3xmm.inds[mpa_spec_m2_3xmm.make_prac][EL_3xmm.bpt_sn_filt][fullxray_xmm.valid][fullxray_xmm.likelyagn_xr]
...
#                      m2Cat_GSW.allmass[make_allm2], gsw_yvals_bpt,
#                      m2Cat_GSW.allz[make_allm2],
#                      m2Cat_GSW.allsfr[make_allm2],
#                      sdssobj,bpt_sn_filt[valid_bpt][stripe82[covered_gsw]],      make_allm2[bpt_sn_filt][valid_bpt][stripe82[covered_gsw]])
...
sfrm_gsw2 = SFRMatch(EL_m2)

sfrm_gsw2.get_highsn_match_only(agn_gsw_bptplus, nonagn_gsw_bptplus, nonagn_gsw_bptplusnii, agn_gsw_bptplusnii, load=True, sncut=2)


sfrm_gsw2.getmatch(agn_gsw_bptplus, nonagn_gsw_bptplus, nonagn_gsw_bptplusnii, agn_gsw_bptplusnii, load=True)
sfrm_gsw2.subtract_elflux(sncut=2)
'''
